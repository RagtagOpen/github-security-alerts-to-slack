# Contributing to GitHub Security Alerts to Slack

First off, thank you for considering contributing to GitHub Security Alerts to Slack. It's people like you that make GitHub Security Alerts to Slack such a great tool.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

GitHub Security Alerts to Slack is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into GitHub Security Alerts to Slack itself.
...
- All changes should be made through by [pull requests](https://help.github.com/articles/about-pull-requests/). Pull requests will be reviewed by one or more of GitHub Security Alerts to Slack's maintainers. Once approved, it is the responsibility of the owner of the pull request to merge the changes to the master/main branch.

## Ways to Get Involved

### Report Bugs

This section guides you through submitting a bug report for GitHub Security Alerts to Slack. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior, and find related reports.
...
- **Did the problem start happening recently** (e.g. after updating to a new version of GitHub Security Alerts to Slack) or was this always a problem?
- If the problem started happening recently, **can you reproduce the problem in an older version of GitHub Security Alerts to Slack?** What's the most recent version in which the problem doesn't happen?
- **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

- **Which version of GitHub Security Alerts to Slack are you using?** If you're using GitHub Security Alerts to Slack on the web, let us know what dates you experienced the issue on.
- **What's the name and version of the operating system you're using?**
- **What's the name and version of the browser you're using?**

### Suggesting Enhancements

This section guides you through submitting an enhancement suggestion for GitHub Security Alerts to Slack, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion and find related suggestions.
...
Unsure where to begin contributing to GitHub Security Alerts to Slack? You can start by looking through these `good first issue` and `help wanted` issues:
...
1.  Get added as a contributor to the project by asking in the Slack room for GitHub Security Alerts to Slack.
1.  Create a new branch in your local copy of the project
1.  If this is your first time contributing to GitHub Security Alerts to Slack, add your name to the CONTRIBUTORS file and include that change in your pull request.
1.  If you like the change and think the project could use it:
    ...
    - Make sure you add new tests to cover your changes (this project uses [Jest](https://jestjs.io/) for writing tests)
    - Open a pull request with your changes
    - GitHub Security Alerts to Slack's maintainers may have questions or suggestions for your work, please respond as soon as you can
